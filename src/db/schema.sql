...
CREATE INDEX IF NOT EXISTS idx_plex_history_runs_status
  ON plex_history_ingestion_runs(status, updated_at DESC);
CREATE INDEX IF NOT EXISTS idx_plex_history_users_status
  ON plex_history_ingestion_users(run_id, status);
CREATE INDEX IF NOT EXISTS idx_plex_history_pages_cursor
  ON plex_history_ingestion_pages(run_id, user_id, start_offset);
CREATE INDEX IF NOT EXISTS idx_plex_history_rows_event
  ON plex_history_ingestion_rows(archive_event_id);
