...
5. **3-6-2C - Canonical Plex Movie Identity And Stale-Key Adoption:** Planned corrective follow-on. Use exact Plex GUIDs to preserve stale rating keys as aliases while making movie grouping, refresh, poster, and backdrop resolution canonical and revision-safe.
