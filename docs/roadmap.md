...
8. **3-6-4A - Plex Play-History Recovery And Reconciliation:** Implemented and deterministically verified 2026-07-21. Paginated dated movie/episode rows are retained additively and exact interval overlaps reconcile without source loss; live canary/apply and projection enablement remain operator-controlled.
