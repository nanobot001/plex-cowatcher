...
Category is one of movie, tv, classic_tv, anime, or audiobook. `other` is excluded from the dashboard export because it is a storage fallback only. Evidence is JSON describing observed, confirmed, prompt, synchronization, and provenance states.
